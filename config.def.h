...
static const char *colors[][3]      = {
	/*               fg       bg        border   */
	[SchemeNorm] = { col_fg1, col_bg0,   col_bg2   },
	[SchemeSel]  = { col_fg0, col_green, col_green },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg0, "-nf", col_fg1, "-sb", col_green, "-sf", col_fg0, NULL };
